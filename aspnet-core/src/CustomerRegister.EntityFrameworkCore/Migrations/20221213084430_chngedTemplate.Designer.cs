...
{
    [DbContext(typeof(CustomerRegisterDbContext))]
    [Migration("20221213084430_chngedTemplate")]
    partial class chngedTemplate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerRegister.Register.CustomerInfo", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("CustomerRegister.Register.TemplateInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("CustomerInfoDataId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CustomerInfoDataId");

                    b.ToTable("AppTemplateInfo", (string)null);
                });
            ...
            modelBuilder.Entity("CustomerRegister.Register.TemplateInfo", b =>
                {
                    b.HasOne("CustomerRegister.Register.CustomerInfo", "CustomerInfoData")
                        .WithMany()
                        .HasForeignKey("CustomerInfoDataId");

                    b.Navigation("CustomerInfoData");
                });
